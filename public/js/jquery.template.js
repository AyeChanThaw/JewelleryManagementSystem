...
(function(factory) {
  ...
  template.prototype = {  
    ...
    _getGmToKpy: function($elm) {
      var html = $('<input type="text" class="form-control" id="gm"><input type="text" class="form-control" id="kyat"><input type="text" class="form-control" id="pae"><input type="text" class="form-control" id="yway">');
